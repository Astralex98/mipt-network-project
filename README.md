...
Установка виртуального окружения. Файл requirements.txt, в котором находятся необходимые библиотеки, приведен в репозитории.
...
По умолчанию конфигурационный файл Config.ini можно не редактировать. В этом файле можно редактировать следующие параметры:
